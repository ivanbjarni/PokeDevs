...
class Presets(object):
	...
	def initAttacks(self):
		...
		17	: Attack("WingAttack", 15, 10, 0, 1, "normal"),	
		21	: Attack("Slam", 18, 25, 0, 0, "normal"),			
		22	: Attack("VineWhip", 7, 5, 0, 0, "grass"),				
		30	: Attack("HornAttack", 15, 20, 0, 1, "normal"),				
		31	: Attack("FuryAttack", 15, 15, 0, 1, "normal"),				
		32	: Attack("HornDrill", 25, 40, 0, 1, "normal"),				
		33	: Attack("Tackle", 7, 5, 0, 0, "normal"),				
		34	: Attack("BodySlam", 15, 20, 0, 0, "normal"),				
		...
		48	: Attack("Supersonic", 5, 20, 0, 2, "normal"),				
		51	: Attack("Acid", 10, 20, 0, 2, "grass"),				
		52	: Attack("Ember", 10, 5, 0, 0, "fire"),			
		53	: Attack("Flamethrower", 16, 30, 0, 0, "fire"),			
		55	: Attack("WaterGun", 18, 20, 0, 0, "water"),			
		...
		65	: Attack("DrillPeck", 32, 65, 0, 1, "normal"),			
		...
		76	: Attack("SolarBeam", 34, 55, 0, 0, "grass"),			
		78	: Attack("StunSpore", 0, 65, 0, 3, "grass"),			
		79	: Attack("SleepPowder", 0, 10, 0, 1, "grass"),			
		80	: Attack("PetalDance", 15, 20, 0, 0, "grass"),			
		81	: Attack("StringShot", 10, 8, 0, 1, "grass"),			
		83	: Attack("FireSpin", 20, 25, 0, 0, "fire"),				
		84	: Attack("ThunderShock", 15, 20, 0, 0, "electric"),				
		...
		93	: Attack("Confusion", 0, 15, 0, 2, "psychic"),							
		94	: Attack("Hypnosis", 0, 10, 0, 2, "psychic"),				
		...
		112 : Attack("Barrier", 0, -23, -10, 0, "psychic"),			
		113 : Attack("LightScreen", -5, 8, -10, 1, "normal"),			
		...
		123 : Attack("Smog", 10, 10, 0, 1, "grass"),	
		124 : Attack("Sludge", 18, 30, 0, 0, "grass"),	
		125 : Attack("BoneClub", 10, 10, 60, 0, "normal"),	
		126 : Attack("FireBlast", 18, 25, 0, 1, "fire"),	
		127 : Attack("Waterfall", 25, 45, 0, 0, "water"),	
		141 : Attack("LeechLife", 15, 20, -15, 0, "normal"),	
		...
		171 : Attack("Nightmare", 10, 50, 0, 2, "psychic"),	
		172 : Attack("FlameWheel", 20, 30, 0, 0, "fire"),	
		173 : Attack("Snore", 0, -35, 0, 0, "normal"),	
		175 : Attack("Flail", 15, 30, 0, 0, "water"),	
		184 : Attack("ScaryFace", 5, 10, 5, 1, "normal"),	
		188 : Attack("SludgeBomb", 25, 40, 0, 0, "grass"),	
		192 : Attack("ZapCannon", 30, 40, 0, 1, "electric"),	
		196 : Attack("IcyWind", 15, 20, 0, 1, "water"),	
		...
		352 : Attack("WaterPulse", 30, 20, 0, 0, "water"),			
		361 : Attack("HealingWish", -5, 5, -20, 0, "normal"),			
		362 : Attack("Brine", 15, 8, 0, 0, "water"),			
		364 : Attack("Feint", 0, -10, -20, 0, "normal"),			
		370 : Attack("CloseCombat", 30, 40, 0, 0, "normal"),			
		382 : Attack("MeFirst", 0, 15, 0, 2, "normal"),			
		390 : Attack("ToxicSpikes", 15, 20, 0, 1, "grass"),			
		394 : Attack("FlareBlitz", 40, 40, 0, 0, "fire"),				
		...
		414 : Attack("EarthPower", 40, 50, 0, 1, "ground"),				
		416 : Attack("GigaImpact", 40, 60, 0, 1, "normal"),				
		422 : Attack("ThunderFang", 15, 6, 0, 1, "electric"),				
		424 : Attack("FireFang", 15, 16, 0, 1, "fire"),				
		...
		506	: Attack("Hex", 0, 25, -25, 2, "psychic"),			
		512	: Attack("Acrobatics", 20, 35, 0, 0, "normal"),			
