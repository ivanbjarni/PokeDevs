...
class Presets(object):
	...
	def initAttacks(self):
		...
		81	: Attack("StringShot", 10, 18, 0, 1, "grass"),			
		...
		113 : Attack("LightScreen", -5, 18, -10, 1, "normal"),			
		...
		246 : Attack("AncientPower", 8, 32, -30, 0, "normal"),			
		...
		305 : Attack("PoisonFang", 20, 30, 0, 1, "normal"),			
